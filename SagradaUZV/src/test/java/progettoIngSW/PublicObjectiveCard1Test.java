...
public class PublicObjectiveCard1Test {
    ...
    @Test
    public void checkPublicCard1() throws IOException {
        Pattern p = new Pattern(0);
        WindowFrame wf = new WindowFrame(p);

        //Calcolo punteggio su wf vuota
        PublicObjectiveCard1 card0 = new PublicObjectiveCard1();
        ...
        PublicObjectiveCard1 card00 = new PublicObjectiveCard1();
        ...
        PublicObjectiveCard1 card1 = new PublicObjectiveCard1();
        assertEquals("Calcolo punteggio sbagliato", 0, card1.scoringCalc(wf));
        try{
            wf.removeDice(4);
        ...
        assertEquals("Calcolo punteggio sbagliato", 6, card1.scoringCalc(wf));
        try{
            wf.removeDice(4);
