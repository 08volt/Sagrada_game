...
public class PublicObjectiveCard6Test {
    ...
    @Test
    public void checkPublicCard6() throws IOException {
        ...
        PublicObjectiveCard6 card6 = new PublicObjectiveCard6();
        assertEquals("Calcolo punteggio sbagliato", 6, card6.scoringCalc(wf));
    }
}
