...
public class PublicObjectiveCard10Test {
    ...
    @Test
    public void checkPublicCard8() throws IOException {
        ...
        PublicObjectiveCard10 card10 = new PublicObjectiveCard10();
        assertEquals("Calcolo punteggio sbagliato", 8, card10.scoringCalc(wf));
    }
}
