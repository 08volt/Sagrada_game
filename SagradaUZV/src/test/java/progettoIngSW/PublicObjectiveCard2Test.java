...
public class PublicObjectiveCard2Test {
    ...
    @Test
    public void checkPublicCard2() throws RulesBreakException, IOException {
        ...
        PublicObjectiveCard2 card2 = new PublicObjectiveCard2();

        assertEquals("Calcolo punteggio sbagliato", 5, card2.scoringCalc(wf));
        ...
        dice.setNumber(4);
        try {
            wf.placeDice(dice, 16);
        } catch (CellNotEmptyException e) {
            e.printStackTrace();
        }
        assertEquals("Calcolo punteggio sbagliato", 10, card2.scoringCalc(wf));
        try{
            wf.removeDice(1);
