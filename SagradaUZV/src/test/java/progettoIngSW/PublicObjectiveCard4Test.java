...
public class PublicObjectiveCard4Test {
    ...
    @Test
    public void checkPublicCard4() throws IOException {
        ...
        PublicObjectiveCard4 card4 = new PublicObjectiveCard4();
        assertEquals("Calcolo punteggio sbagliato", 12, card4.scoringCalc(wf));
        try{
            wf.removeDice(1);
        ...
        assertEquals("Calcolo punteggio sbagliato", 8, card4.scoringCalc(wf));
    }
}
