...
public class PublicObjectiveCard7Test {
    ...
    @Test
    public void checkPublicCard7() throws IOException {
        ...
        PublicObjectiveCard7 card7 = new PublicObjectiveCard7();
        assertEquals("Calcolo punteggio sbagliato", 4, card7.scoringCalc(wf));
    }
}
