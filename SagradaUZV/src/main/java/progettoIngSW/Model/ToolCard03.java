...
public class ToolCard03 implements ToolCard {
     ...
     */
    public ToolCard03(WindowFrame wf, int i1, int i2) {
        super();
        this.i1 = i1;
        this.i2 = i2;
        this.w = wf;
    ...
    //
    /**
     * Sposta il dado dalla cella in posizione i1 alla cella in posizione i2 senza considerare le restrizioni di valore
    ...
    public void useToolCard() throws DiceNotFoundException, RulesBreakException, CellNotEmptyException {
        ...
        w.getCell(i2).setNumberFlag(false);

        try {
            w.moveDice(i1,i2);
        } catch (Exception e) {
            w.getCell(i2).setNumberFlag(true);
            throw e;
        }
